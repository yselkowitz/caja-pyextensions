...
import caja, urllib, os, subprocess
...
class OpenTerminalGeometry(caja.MenuProvider):
    ...
    def run(self, menu, selected):
        ...
        bash_string = "mate-terminal --geometry=" + GEOMETRY + " --working-directory='" + curr_dir + "' &"
    ...
    def get_file_items(self, window, sel_items):
        ...
        item = caja.MenuItem('CajaPython::terminal',
