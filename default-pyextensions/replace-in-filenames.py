...
GLADE_PATH = "/usr/share/caja-pyextensions/glade/caja-pyextensions_replace.glade"
...
class ReplaceInFilenames(caja.MenuProvider):
    ...
    def get_file_items(self, window, sel_items):
        ...
        item = caja.MenuItem('CajaPython::gtk-find-and-replace',
